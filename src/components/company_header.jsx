...
function Company_header() {
  ...
  return (
    <div className="relative h-screen-max sm:h-[70vh] overflow-hidden">
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-10 sm:py-12">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12 lg:gap-20 xl:gap-28">
          ...
          <div className="w-full lg:w-1/2 text-left space-y-6 lg:ml-30">
            <h2 className="font-montserrat text-white font-light text-[18px] sm:text-[20px] md:text-[22px] lg:text-[26px] leading-[140%] text-justify">
              TecHubble is a client-centric product studio with your best
              interest at heart. We stay with you throughout the process,
              creating, testing, and
              <span className="text-[28px] font-medium"> improving</span> the
              product as time goes by. We ensure that your products are
              <span className="text-[28px] font-medium"> scalable and flexible</span>. To make it easier for you, we have created a
              <span className="text-[28px] font-medium"> platform</span> that
              helps you create a
              <span className="text-[28px] font-medium"> minimal viable product</span> within three months, which is 4x faster than the market processes.
            </h2>
